          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                   ...
                   <li class="active"><a href="EditAUDI.php">Edit User</a></li>
               ...
               <div class="col-sm-10">
			      <div class="col-sm-12" style=" background: rgba(0,0,0,0.65)">
                    ...
                    <div class="panel-body">
						  <!-- insert user-->
					<form name="userInsert" method="post" action="insertUserDetailsAUDI.php">
							
                      <fieldset class="col-md-12">
						  
						  
					     <legend>Insert new user to AUDITORIUM</legend>
				   ...
				   <br><br>
					  ...
					  <form name="userDelete" method="post" action="insertUserDetailsAUDI.php"> 
				    <fieldset class="col-md-12">  	
					   <legend>Delete user from AUDITORIUM</legend>
			           <div class="form-group">
...
<option value="">Select Name(EPF number)</option>  
    ...
    $query = "select * from staff_member_audi";
    ...
    ?>
					  ...
					  <form name="userUpdate" method="post" action="insertUserDetailsAUDI.php"> 
				    <fieldset class="col-md-12">  	
					   <legend>Update user from AUDITORIUM</legend>
			           <div class="form-group">
                           <!--<select class="form-control" id="exampleFormControlSelect1" name="userDelete[user_delete]" onChange="location = this.value;">
					   <option>Select department</option>
                       <option value="insertuserDetailsSOC.php">SOC</option>
...
<option value="">Select Name(EPF number)</option>  
    ...
    ?>
					  ...
					  <br><br>
					   ...
					   <div class="panel-body">
						  <!-- insert user-->
					<form name="userUpdate1" method="post" action="insertUserDetailsAUDI.php">
