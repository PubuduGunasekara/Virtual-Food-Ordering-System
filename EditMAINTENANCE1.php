			      ...
			      <div class="col-sm-12" style=" background: rgba(0,0,0,0.65)">
					...
					<form name="userInsert" method="post" action="insertUserDetailsMaintenence.php">
                      ...
                      <fieldset class="col-md-12">
					     ...
					     <legend>Inset new user to Maintenance</legend>
						 
							 
				         <div class="form-group">							 
							 
                           <label >EPF NUMBER:</label>
                           <input type="text" class="form-control" placeholder="Enter EPF" name="userInsert[user_id]" id="sid" pattern="[0-9]{3}" required title="Enter EPF no with 3 integers" >
                         </div>
...
<option>Select Name</option>  
    ...
    ?>
						   ...
						   <select class="form-control" id="exampleFormControlSelect1" name="userUpdate[user_update_location]">
							   ...
							   <option value="admin">MAINTENENCE</option> 
