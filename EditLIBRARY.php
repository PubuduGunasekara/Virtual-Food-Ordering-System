          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                   ...
                   <li class="active"><a href="EditLIBRARY.php">Edit User</a></li>
               ...
               <div class="col-sm-10">
			      <div class="col-sm-12" style=" background: rgba(0,0,0,0.65)">
                    ...
                    <div class="panel-body">
						  <!-- insert user-->
					<form name="userInsert" method="post" action="insertUserDetailsLIBRARY.php">
							
                      <fieldset class="col-md-12">
						  
						  
					     <legend>Insert new user to Library</legend>
				   ...
				   <br><br>
					  ...
					  <form name="userDelete" method="post" action="insertUserDetailsLIBRARY.php"> 
				    <fieldset class="col-md-12">  	
					   <legend>Delete user from LIBRARY</legend>
			           <div class="form-group">
...
<option>Select Name(EPF number)</option>  
   	 <?php
    ...
    $query = "SELECT * FROM staff_member_library";
    ...
    ?>
					  ...
					  <form name="userUpdate" method="post" action="insertUserDetailsLIBRARY.php"> 
				    <fieldset class="col-md-12">  	
...
<option value="">Select Name(EPF number)</option>  
    ...
    ?>
					  ...
					  <br><br>
					   ...
					   <div class="panel-body">
						  <!-- insert user-->
					<form name="userUpdate1" method="post" action="insertUserDetailsLIBRARY.php">
