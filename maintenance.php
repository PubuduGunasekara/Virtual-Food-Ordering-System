...
<body background="Recipes.jpg">
                ...
                <span class="icon-bar"></span>                        
					...
					<ul class="nav navbar-nav">
								...
								<li ><a href="sob.php">SOB</a>
									<li ><a href="soe.php">SOE</a>
										...
										<li ><a href="rec.php">RECREATIONAL</a>
											<li class="active" ><a href="maintenance.php">MAINTENANCE</a>
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li style="color: red;"><a href="maintenanceSpecial.php">Special Menu</a>
							</li>
	...
	<div class="container-fluid">
		...
		<div class="row jumbotron" style="height: auto; background-color:#E9E9E9">
			...
			<form name="socUserSelect" method="post" action="maintenancenamelistTemp.php">
