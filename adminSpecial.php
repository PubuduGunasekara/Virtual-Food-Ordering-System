                ...
                <span class="icon-bar"></span>                        
					...
					<div class="collapse navbar-collapse" id="myNavbar">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li style="color: red;" class="active"><a href="adminSpecial.php">Admin Special Menu</a>
							</li>
...
<h4  style="color: red;">*Friday only.(Conditions may apply)</h4>
			...
			<form name="socUserSelect" method="post" action="adminnamelistTempSpecial.php">
				...
				<table border="1" class="table-hover table-condensed" id="details" >
					...
					<tbody>
						...
						$query = "SELECT * FROM staff_member_admin WHERE date != '$date' ORDER BY nsbm_id";
...
<a href="admin.php"><input type="button" class="btn btn-primary" style="float: left" value="Go back"></a>
		</div>
		</form>
