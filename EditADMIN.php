          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                   ...
                   <li class="active"><a href="EditADMIN.php">Edit User</a></li>
               ...
               <div class="col-sm-10">
			      <div class="col-sm-12" style=" background: rgba(0,0,0,0.65)">
                    ...
                    <div class="panel-body">
						  <!-- insert user-->
					<form name="userInsert" method="post" action="insertUserDetailsADMIN.php">
							
                      <fieldset class="col-md-12">
						  
						  
					     <legend>Insert new user to ADMIN</legend>
				   ...
				   <br><br>
					  ...
					  <form name="userDelete" method="post" action="insertUserDetailsADMIN.php"> 
				    <fieldset class="col-md-12">  	
					   <legend>Delete user from ADMIN</legend>
			           <div class="form-group">
...
<option value="">Select Name(EPF number)</option>  
    ...
    $query = "select * from staff_member_admin";
...
<option value="<?php echo $rows['nsbm_id'];?>"><?php echo "".$rows['name']."(".$rows['nsbm_id'].")";?></option>
    ...
    ?>
					  ...
					  <form name="userUpdate" method="post" action="insertUserDetailsADMIN.php"> 
				    <fieldset class="col-md-12">  	
...
<option value="">Select Name(EPF number)</option>  
    ...
    ?>
					  ...
					  <br><br>
					   ...
					   <div class="panel-body">
						  <!-- insert user-->
					<form name="userUpdate1" method="post" action="insertUserDetailsADMIN.php">
