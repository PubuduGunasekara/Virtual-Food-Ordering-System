...
<body background="Recipes.jpg">
                ...
                <span class="icon-bar"></span>                        
					...
					<div class="collapse navbar-collapse" id="myNavbar">
										...
										<li ><a href="rec.php">RECREATIONAL</a>
											...
											<li ><a href="medical.php">MEDICAL</a>
												<li ><a href="lybrary.php">LIBRARY</a>
													<li class="active"><a href="audi.php">AUDITORIUM</a>
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li style="color: red;"><a href="audiSpecial.php">Special Menu</a>
							</li>
	...
	<div class="container-fluid">
		...
		<div class="row jumbotron" style="height: auto; background-color:#E9E9E9">
			...
			<form name="socUserSelect" method="post" action="audinamelistTemp.php">
