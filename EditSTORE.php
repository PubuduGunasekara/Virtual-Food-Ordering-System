          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                   ...
                   <li class="active"><a href="EditSTORE.php">Edit User</a></li>
               ...
               <div class="col-sm-10">
			      <div class="col-sm-12" style=" background: rgba(0,0,0,0.65)">
                    ...
                    <div class="panel-body">
						  <!-- insert user-->
					<form name="userInsert" method="post" action="insertUserDetailsSTORE.php">
							
                      <fieldset class="col-md-12">
						  
						  
					     <legend>Insert new user to STORES</legend>
				   ...
				   <br><br>
					  ...
					  <form name="userDelete" method="post" action="insertUserDetailsSTORE.php"> 
				    <fieldset class="col-md-12">  	
					   <legend>Delete user from STORES</legend>
			           <div class="form-group">
...
<option value="">Select Name(EPF number)</option>  
    ...
    $query = "select * from staff_member_store";
    ...
    ?>
					  ...
					  <form name="userUpdate" method="post" action="insertUserDetailsSTORE.php"> 
				    <fieldset class="col-md-12">  	
					   <legend>Update user from STORES</legend>
			           <div class="form-group">
                           <!--<select class="form-control" id="exampleFormControlSelect1" name="userDelete[user_delete]" onChange="location = this.value;">
					   <option>Select department</option>
                       <option value="insertuserDetailsSOC.php">SOC</option>
...
<option value="">Select Name(EPF number)</option>  
  ...
  <option value="<?php echo $rows['nsbm_id'];?>"><?php echo "".$rows['name']."(".$rows['nsbm_id'].")";?></option>
    ...
    ?>
					   ...
					   <div class="panel-body">
						  <!-- insert user-->
					<form name="userUpdate1" method="post" action="insertUserDetailsSTORE.php">
