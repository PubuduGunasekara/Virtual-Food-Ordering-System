...
<html>
<head>
	<title>MAINTENANCE SPECIAL</title>
	<meta charset="utf-8">
...
<body background="Recipes.jpg">
                ...
                <span class="icon-bar"></span>                        
					...
					<div class="collapse navbar-collapse" id="myNavbar">
								...
								<li ><a href="sob.php">SOB</a>
									<li ><a href="soe.php">SOE</a>
										...
										<li ><a href="rec.php">RECREATIONAL</a>
											...
											<li ><a href="medical.php">MEDICAL</a>
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li style="color: red;" class="active"><a href="maintenanceSpecial.php">Maintenance Special Menu</a>
							</li>
	...
	<center><div  style="background-color:ivory;  opacity: 0.6">
		<h3 class="display-2" style="color: #570808; font-family:  Open Sans, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', 'serif'; font-size: 40px; opacity: 1.0; font-weight: bolder;">Select Special Food Item(s)</h3>
		</div>
	</center>
	<div class="container-fluid">
...
<h4  style="color: red;">*Friday only.(Conditions may apply)</h4>



			<form name="socUserSelect" method="post" action="maintenancenamelistTempSpecial.php">
				...
				<table border="1" class="table-hover table-condensed" id="details" >
					...
					<tbody>
						...
						$query = "SELECT * FROM staff_member_maintenance WHERE date != '$date' ORDER BY nsbm_id";
		...
		<label><input type="radio" name="<?php echo $radio;?>" id="<?php echo $radio;?>" onClick="checkRadio('<?php echo $checkbox; ?>')" value="special_c">&nbsp;&nbsp;<img src="chicken.png" style="width: 50px; height: 30px"><BR>SPECIAL CHICKEN </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

								<label><input type="radio" name="<?php echo $radio;?>" id="<?php echo $radio;?>" onClick="checkRadio('<?php echo $checkbox; ?>')" value="special_f">&nbsp;&nbsp;<img src="Fish.png" style="width: 50px; height: 30px"><BR>SPECIAL FISH</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

								<label><input type="radio" name="<?php echo $radio;?>" id="<?php echo $radio;?>" onClick="checkRadio('<?php echo $checkbox; ?>')" value="special_e">&nbsp;&nbsp;<img src="egg.png" style="width: 50px; height: 30px"><BR>SPECIAL EGG
	    						</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

								<label><input type="radio" name="<?php echo $radio;?>" id="<?php echo $radio;?>" onClick="checkRadio('<?php echo $checkbox; ?>')" value="special_v">&nbsp;&nbsp;<img src="vegi.png" style="width: 50px; height: 30px"><BR>SPECIAL VEGI </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<a href="maintenance.php"><input type="button" class="btn btn-primary" style="float: left" value="Go back"></a>
		</div>
		</form>
