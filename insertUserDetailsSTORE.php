...
<body>
	...
	if($num < 1){
        ...
        }else
       {
			...
			echo '<script type="text/javascript">alert("EPF number : '.$id.' is available inside the database.");window.location.assign("EditSTORE.php");</script>';
		}
	...
	$sql = "DELETE FROM staff_member_store WHERE nsbm_id = '$name'";
