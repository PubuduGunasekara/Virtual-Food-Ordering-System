<html>
	<title>Medical selected list</title>
	<head>
<meta charset="utf-8">
...
<?php
	...
	$sql = "select * from staff_member_medi";
	...
	$radio = "radio".$i;
		...
		$food =$_POST[$radio];
			  ...
			  $getname = "select name from staff_member_medi where nsbm_id = '$epf'";
		...
		if($result -> num_rows > 0 ){
			...
			while($row = $result -> fetch_assoc()){
			  ...
			  $sql = "INSERT INTO orders(epf,member_name,food_item,date,location) VALUES ('$epf','$name','$food','$date','medi')";
				$insert = mysqli_query($conn,$sql);
			$sql2 = "UPDATE staff_member_medi SET date = '$dateTommorow' where nsbm_id = '$epf'";
...
?>
			   ...
			   <br>
			   <a href="medicalSpecial.php"><input type="button" class="btn btn-success" style="float: right" value="Close"></a>
		   </form>
		</div>
	</div>
</body>	
