          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                   ...
                   <li class="active"><a href="EditSOE.php">Edit User</a></li>
               ...
               <div class="col-sm-10">
			      <div class="col-sm-12" style=" background: rgba(0,0,0,0.65)">
                    ...
                    <div class="panel-body">
						  <!-- insert user-->
					<form name="userInsert" method="post" action="insertUserDetailsSOE.php">
							
                      <fieldset class="col-md-12">
						  
						  
					     <legend>Insert new user to SOE</legend>
				   ...
				   <div class="panel-body">
					  ...
					  <form name="userDelete" method="post" action="insertUserDetailsSOE.php"> 
				    <fieldset class="col-md-12">  	
					   <legend>Delete user from SOE</legend>
			           <div class="form-group">
...
<option value="">Select Name(EPF number)</option> 
    ...
    $query = "select * from staff_member_soe ORDER BY name";
    ...
    ?>
					  ...
					  <form name="userUpdate" method="post" action="insertUserDetailsSOE.php"> 
				    <fieldset class="col-md-12">  	
...
<option value="">Select Name(EPF number)</option>  
    ...
    $query = "select * from staff_member_soe";
    $results = mysqli_query($conn,$query);
    ...
    ?>
					  ...
					  <br><br>
					   ...
					   <div class="panel-body">
						  <!-- insert user-->
					<form name="userUpdate1" method="post" action="insertUserDetailsSOE.php">
