...
<body>
	...
	$sql = "INSERT INTO staff_member_audi (nsbm_id,name,tel) VALUES ('$id','$name','$tel')";
	...
	if($num < 1){
        ...
        { 
                 echo '<script type="text/javascript">alert("SUCCESSFULLY INSERTED ONE RECORD");window.location.assign("EditAUDI.php");</script>';
        }else
       {
               echo '<script type="text/javascript">alert("error");window.location.assign("EditAUDI.php");</script>';
        }
	}
		else{
			echo '<script type="text/javascript">alert("EPF number : '.$id.' is available inside the database.");window.location.assign("EditAUDI.php");</script>';
		}
	...
	$sql = "DELETE FROM staff_member_audi WHERE nsbm_id = '$name'";
	...
	if(mysqli_query($conn,$sql) && mysqli_query($conn,$sql2)) //output success or failure messages
        { 
                 echo '<script type="text/javascript">alert("SUCCESSFULLY DELETED ONE RECORD");window.location.assign("EditAUDI.php");</script>';
        }else
       {
               echo '<script type="text/javascript">alert("error");window.location.assign("EditAUDI.php");</script>';
        }
...
if(isset($_POST['userUpdate'])){
	...
	$sql1 = "select * from staff_member_audi where nsbm_id = '$epfname'";
	...
	$sql = "DELETE FROM staff_member_audi WHERE nsbm_id = '$epfname'";
	...
	if( mysqli_query($conn,$sql2) && mysqli_query($conn,$sql) ) //output success or failure messages
		...
		echo '<script type="text/javascript">alert("SUCCESSFULLY UPDATED ONE RECORD");window.location.assign("EditAUDI.php");</script>';
        }else
       {
               echo '<script type="text/javascript">alert("error");window.location.assign("EditAUDI.php");</script>';
        }
	...
	if(mysqli_connect_errno()){
		...
		$update = "UPDATE staff_member_audi SET name = '$name' where nsbm_id = '$id'";
