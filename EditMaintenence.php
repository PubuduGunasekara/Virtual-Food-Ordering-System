          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                   ...
                   <li class="active"><a href="EditMaintenence.php">Edit User</a></li>
               ...
               <div class="col-sm-10">
			      <div class="col-sm-12" style=" background: rgba(0,0,0,0.65)">
                    ...
                    <div class="panel-body">
						  <!-- insert user-->
					<form name="userInsert" method="post" action="insertUserDetailsMaintenence.php">
							
                      <fieldset class="col-md-12">
						  
						  
					     <legend>Insert new user to Maintenance</legend>
				   ...
				   <div class="panel-body">
					  ...
					  <form name="userDelete" method="post" action="insertUserDetailsMaintenence.php"> 
				    <fieldset class="col-md-12">  	
					   <legend>Delete user from Maintenance</legend>
			           <div class="form-group">
						   
						   
						   
       <select class="form-control" required title="Please Select one" id="exampleFormControlSelect1" name="userDelete[user_delete]">
<option value="">Select Name(EPF number)</option> 
    ...
    $query = "select * from staff_member_maintenance ORDER BY name";
    ...
    ?>
					  ...
					  <form name="userUpdate" method="post" action="insertUserDetailsMaintenence.php"> 
				    <fieldset class="col-md-12">  	
...
<select class="form-control" id="exampleFormControlSelect1" required title="Please Select one" name="userUpdate[user_update_name]">
<option value="">Select Name(EPF number)</option>  
   	 <?php
    ...
    $query = "select * from staff_member_maintenance";
    $results = mysqli_query($conn,$query);
 ...
 <option value="<?php echo $rows['nsbm_id'];?>"><?php echo "".$rows['name']."(".$rows['nsbm_id'].")";?></option>
    ...
    ?>
						   ...
						   <br><br>
						   <select class="form-control" required title="Please Select one" id="exampleFormControlSelect1" name="userUpdate[user_update_location]">
					  ...
					  <br><br>
					   ...
					   <div class="panel-body">
						  <!-- insert user-->
					<form name="userUpdate1" method="post" action="insertUserDetailsMaintenence.php">
                      ...
                      <fieldset class="col-md-12">
						...
						<select class="form-control" required title="Please Select one" id="exampleFormControlSelect1" name="userUpdate1[user_update_name]">
<option value="">Select Name(EPF number)</option>  
   	 <?php
    ...
    ?>
                         ...
                         <button type="submit" class="btn btn-primary">Cancel</button>
				         <button type="submit" class="btn btn-warning" style="float: right" onClick="return confirm('Are you sure you want to delete this user?')">Update</button>
