                ...
                <span class="icon-bar"></span>                        
					...
					<div class="collapse navbar-collapse" id="myNavbar">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li style="color: red;" class="active"><a href="medicalSpecial.php">Medical Special Menu</a>
							</li>
...
<h4  style="color: red;">*Friday only.(Conditions may apply)</h4>
			...
			<form name="socUserSelect" method="post" action="medicalnamelistTempSpecial.php">
...
<a href="medical.php"><input type="button" class="btn btn-primary" style="float: left" value="Go back"></a>
		</div>
		</form>
