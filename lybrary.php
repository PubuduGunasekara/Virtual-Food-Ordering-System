...
<body background="Recipes.jpg">
                ...
                <span class="icon-bar"></span>                        
					...
					<ul class="nav navbar-nav">
									...
									<li ><a href="soe.php">SOE</a>
										...
										<li ><a href="rec.php">RECREATIONAL</a>
											...
											<li ><a href="medical.php">MEDICAL</a>
												<li class="active" ><a href="lybrary.php">LIBRARY</a>
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li style="color: red;"><a href="librarySpecial.php">Special Menu</a>
							</li>
	...
	<div class="container-fluid">
		...
		<div class="row jumbotron" style="height: auto; background-color:#E9E9E9">
			...
			<form name="socUserSelect" method="post" action="librarynamelistTemp.php">


				<table border="1" class="table-hover table-condensed" id="details" >
					<thead>
						<tr>
							<th>Member name(EPF)</th>
							<th>Food item</th>
						</tr>
					</thead>
					<tbody>
