          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                   ...
                   <li class="active"><a href="EditMEDICAL.php">Edit User</a></li>
               ...
               <div class="col-sm-10">
			      <div class="col-sm-12" style=" background: rgba(0,0,0,0.65)">
                    ...
                    <div class="panel-body">
						  <!-- insert user-->
					<form name="userInsert" method="post" action="insertUserDetailsMEDICAL.php">
							
                      <fieldset class="col-md-12">
						  
						  
					     <legend>Insert new user to MEDICAL</legend>
				   ...
				   <br><br>
					  ...
					  <form name="userDelete" method="post" action="insertUserDetailsMEDICAL.php"> 
				    <fieldset class="col-md-12">  	
					   <legend>Delete user from MEDICAL</legend>
			           <div class="form-group">
...
<select class="form-control" id="exampleFormControlSelect1" required title="Please Select one" name="userDelete[user_delete]">
<option value="">Select Name(EPF number)</option>  
    ...
    $query = "select * from staff_member_medi";
    ...
    ?>
					  ...
					  <form name="userUpdate" method="post" action="insertUserDetailsMEDICAL.php"> 
				    <fieldset class="col-md-12">  	
...
<option value="">Select Name(EPF number)</option>  
    ...
    ?>
					  ...
					  <br><br>
					   ...
					   <div class="panel-body">
						  <!-- insert user-->
					<form name="userUpdate1" method="post" action="insertUserDetailsMEDICAL.php">
