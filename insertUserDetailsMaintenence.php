...
<body>
	...
	if($num < 1){
        ...
        { 
                 echo '<script type="text/javascript">alert("SUCCESSFULLY INSERTED ONE RECORD");window.location.assign("EditMaintenence.php");</script>';
        }else
       {
			...
			echo '<script type="text/javascript">alert("EPF number : '.$id.' is available inside the database.");window.location.assign("EditMaintenence.php");</script>';
		}
	...
	if(mysqli_connect_errno()){
		...
		$update = "UPDATE staff_member_maintenance SET name = '$name' where nsbm_id = '$id'";
