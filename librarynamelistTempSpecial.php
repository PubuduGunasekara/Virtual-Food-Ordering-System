<html>
	<title>Library selected list</title>
	<head>
<meta charset="utf-8">
...
<script src="//code.jquery.com/jquery-1.11.1.min.js"></script>
   ...
   <div class="col-lg-12 col-md-12 col-sm-12">
	   <form method="post" name="socForm">
		   ...
		   <div class='grid '>
<table class='table table-striped' style='overflow-x: hidden;overflow-y: hidden; height:300px'>
...
<?php
	...
	$sql = "select * from staff_member_library";
	...
	$radio = "radio".$i;
		...
		$food =$_POST[$radio];
			  ...
			  $getname = "select name from staff_member_library where nsbm_id = '$epf'";
		...
		if($result -> num_rows > 0 ){
			...
			while($row = $result -> fetch_assoc()){
			  ...
			  $sql = "INSERT INTO orders(epf,member_name,food_item,date,location) VALUES ('$epf','$name','$food','$date','l')";
				$insert = mysqli_query($conn,$sql);
			$sql2 = "UPDATE staff_member_library SET date = '$dateTommorow' where nsbm_id = '$epf'";
...
?>
			   ...
			   <br>
			   <a href="librarySpecial.php"><input type="button" class="btn btn-success" style="float: right" value="Close"></a>
		   </form>
		</div>
	</div>
</body>	
